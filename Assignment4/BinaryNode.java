...
public class BinaryNode<T>
{
   ...
   public BinaryNode<T> copy()
   {
	...
	public StringBuilder inOrderToString(){
		return inOrderToString(this, new StringBuilder(""));
	}
	
	// returns inOrder traversal as a StringBuilder
	private StringBuilder inOrderToString(BinaryNode<T> node, StringBuilder nodeData){
		if (node != null)
		{
			inOrderToString(node.leftChild, nodeData);
			nodeData.append(node.getData());
			inOrderToString(node.rightChild, nodeData);
		}
		return nodeData;
	}
